...
var KTDropzoneDemo = function () {
  ...
  var demo3 = function demo3() {
    ...
    myDropzone5.on("sending", function (file, xhr, formData) {// add csrf token to image
    ...
    myDropzone5.on("removedfile", function (file, xhr, formData) {
      ...
      var id = JSON.parse(file.xhr.response).data.id; // console.log(id);
...
module.exports = __webpack_require__(/*! /Users/core/WebstormProjects/qr-product/resources/metronic/js/pages/crud/file-upload/dropzonejs.js */"./resources/metronic/js/pages/crud/file-upload/dropzonejs.js");
