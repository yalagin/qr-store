        ...
        <div
            ...
            <div class="d-flex flex-column-fluid flex-center">
                ...
                <div class="login-form login-forgot">
                    <!--begin::Form-->
                    <form class="form" novalidate="novalidate" id="kt_login_forgot_form" method="post" action="{{ url('/password/reset') }}" >
                    @csrf
                    ...
                    <!--begin::Title-->
                        <div class="pb-13 pt-lg-0 pt-5">
                            <h3 class="font-weight-bolder text-dark font-size-h4 font-size-h1-lg">Forgotten Password
                                ?</h3>
                            <p class="text-muted font-weight-bold font-size-h4">Enter your email and password to reset your
                                account</p>
                        </div>
                        <!--end::Title-->
                        {{debug(old())}}
